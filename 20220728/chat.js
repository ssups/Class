...
io.on("connection", socket => {
    ...
    socket.on("secretRoom", name => {
        socket.join(name);
    });
    socket.on("secretChat", (name, targetNickNameVal, secretMsgVal) => {
        io.to(targetNickNameVal).emit("secretChat", name, targetNickNameVal, secretMsgVal);
        io.to(name).emit("secretChatMe", name, targetNickNameVal, secretMsgVal);
    });
